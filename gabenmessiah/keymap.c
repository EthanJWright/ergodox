 ...
 * `--------+-----+-----+-----+-----+------------'           `------------+-----+-----+-----+-----+--------'
 *   | LGui |Ctrl | Alt |LGUI |Lower|                                     |Raise|Play |VDown|VUp  |Next  |
 *   `------------------------------'                                     `------------------------------'
 *                                   ,------------.          ,------------.
 *                                   |LCtr |LAlt  |          | LAlt |LCtr |
 *                              ,----|-----|------|          |------+-----+-----.
...
[_QWERTY] = LAYOUT_ergodox(
  ...
  KC_TAB,   KC_Q,    KC_W,    KC_E,    KC_R,  KC_T, LKGAME,
  KC_LCTL,   KC_A,    KC_S,    KC_D,    KC_F,  KC_G,
  KC_LSFT,  KC_Z,    KC_X,    KC_C,    KC_V,  KC_B, GAME,
  KC_LGUI, KC_GRV, KC_LALT, KC_LGUI, LOWER,
...
[_LOWER] = LAYOUT_ergodox(
  ...
  KC_DEL,  KC_F1,   KC_F2,   KC_F3,   KC_F4,    KC_F5,   KC_F6,
  ...
  KC_F5,  KC_F6,   KC_UNDS,    KC_PLUS,    KC_LCBR, KC_RCBR, KC_PIPE,
...
[_RAISE] = LAYOUT_ergodox(
  ...
  // right hand
  KC_F12, KC_F6,  KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,
  KC_F5,  KC_F6,  KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS,
 ...
 * |--------+-----+-----+-----+-----+-----|      |           |      |-----+-----+-----+-----+-----+--------|
 * |  LCtr  |  A  |  S  |  D  |  F  |  G  |------|           |------|LEFT |DOWN |UP   |RIGHT|  ;  |    '   |
 * |--------+-----+-----+-----+-----+-----|  L1  |           |  L1  |-----+-----+-----+-----+-----+--------|
 * | LShift |  Z  |  X  |  C  |  V  |  B  |      |           |      |  N  |  M  |  ,  |  .  |  /  | Enter  |
 * `--------+-----+-----+-----+-----+------------'           `------------+-----+-----+-----+-----+--------'
 *   | LGui |Ctrl | Alt |LGUI |Lower|                                     |Raise|Left |Down | Up  |Right |
 *   `------------------------------'                                     `------------------------------'
 *                                   ,------------.          ,------------.
 *                                   |LCtr |LAlt  |          | LAlt |LCtr |
 *                              ,----|-----|------|          |------+-----+-----.
...
[_GAME] = LAYOUT_ergodox(
  ...
  KC_ESC,      KC_6, KC_7,  KC_8,    KC_9,    KC_0,                KC_DEL,
  KC_LBRACKET, KC_Y, KC_U,  KC_I,    KC_O,    KC_P,                KC_RBRACKET,
               KC_LEFT, KC_DOWN,  KC_UP,    KC_RIGHT,    KC_SCOLON,           KC_QUOTE,
